...
- **Project Memory Bridge** : Importe les tâches Google Tasks comme notes Obsidian (synchronisation bidirectionnelle du statut, sans suppression distante)
...
│  └─ notifications/      # Decoupled notification service
